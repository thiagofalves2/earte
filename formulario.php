...
<html>
	<head>
		...
		<script src="ajax/js/jquery.iframe-transport.js"></script>
		<script src="ajax/js/jquery-ui-1.9.2.custom.js"></script>
		<script src="ajax/js/jquery.fileupload.js"></script>
		<script src="cidades.js" type="text/javascript"></script>
		<script src="script.js" type="text/javascript"></script>
		<title>Sistema EArte | Ficha de Classificação</title>
	</head>
	<body>
		<?php
      ...
      <fieldset>
		        <label for="enviarTese">Enviar trabalho
						<input id="fileupload" type="file" name="filesctl">
						<div id="progress"></div>
					</label>
					</fieldset>
				</form>
