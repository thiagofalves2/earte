...
<html>
	<head>
		...
		<title>Sistema Earte | Busca</title>
	</head>
	<body>
		<?php
		...
		?>
		<a class="button" href="index.php">Voltar</a><br><br>
		<form name="formulario" action="buscar.php" method="post">
		<input class="button right" type="submit" value="Buscar"><br><br>
			<fieldset>
				...
				<label class="right nodisplay" for="consolidada">Consolidada
					<?php
