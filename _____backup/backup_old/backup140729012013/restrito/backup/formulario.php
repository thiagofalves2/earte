		...
		?>
			<fieldset>
				...
				<fieldset>
					...
					$fdao=new FocoDAO();
					if($outroFoco){
						echo "<label class=\"widelabel\" for=\"outrofocoS\">Outro Tema";
					} else {
						echo "<label class=\"nodisplay widelabel\" for=\"outrofocoS\">Outro Tema";
					}
					?>
						<select name="outrofocoS" class="wideinput">
							<option value="">Selecione um Tema</option>
							<option value="new">Novo Tema...</option>
						<?php
						if($foco!=null) {
