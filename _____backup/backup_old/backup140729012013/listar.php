...
<?php
	...
	if(isset($_SESSION['listar'])&&$_SESSION['listar']!=null){
		...
		foreach($ids as $id){
			...
			echo 'Orientador: '.mb_strtoupper($temp_orientador[1],'UTF-8').', '.$temp_orientador[0].'<br><br>';
			...
			if($string_contexto_educacional != ''){
				...
				echo "Contexto Educacional em Dúvida<br><br>";
			}
			...
			if($string_modalidades!=''){
				...
				echo "Modalidades em Dúvida<br><br>";
			}
			...
			if(isset($string_area_curricular_final)&&$string_area_curricular_final){
				...
				echo "Área Curricular em Dúvida";
			}
			...
			if($string_area_conhecimento!=''){
				...
				echo "Área de Conhecimento em Dúvida<br><br>";
			}
