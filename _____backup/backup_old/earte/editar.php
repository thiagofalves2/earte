	...
	<body>
		...
		<?php
			...
			if(isset($_POST["idFicha"])&&$_POST["idFicha"]!=null&&$_POST["idFicha"]!=""){
				...
				echo "A ficha foi editada com sucesso<br /><br /><a href=\"index.php\" alt=\"Voltar\">Voltar</a>";
			} else {
				echo "Nenhuma ficha foi editada<br /><br /><a href=\"index.php\" alt=\"Voltar\">Voltar</a>";
			}
		?>
	</body>
</html>