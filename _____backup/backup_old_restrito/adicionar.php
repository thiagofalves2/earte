	...
	<body>
		...
		<?php
			...
			function upper($str) {
				...
				$idao->insertData($identificacao);
				$id_ident=$idao->getLastInsertedId();
				$ficha->setId_identificacao($id_ident);
				
				//Contexto educacional
				$cdao=new Contexto_educacionalDAO();
				$contexto_educacional=new Contexto_educacional('','','','','','','','');
				...
				$cdao->insertData($contexto_educacional);
				$id_contexto_educacional=$cdao->getLastInsertedId();
				$ficha->setId_contexto_educacional($id_contexto_educacional);
				...
				//Outro Foco
				if(!isset($_POST["focotematico"])||$_POST["focotematico"]!="outro"){
					$tema_estudo->setId_foco(null);
				} else {
					if($_POST["outrofocoS"]==""){
						$tema_estudo->setId_foco(null);
					} else if($_POST["outrofocoS"]=="new"){
						$novoFoco=new Foco("",upper($_POST["outrofoco"]));
						$fdao=new FocoDAO();
						$fdao->insertData($novoFoco);
						$id=$fdao->getLastInsertedId();
						$tema_estudo->setId_foco($id);
					} else {
						$tema_estudo->setId_foco($_POST["outrofocoS"]);
					}
				}
				$tedao->insertData($tema_estudo);
				$id_tema_estudo=$tedao->getLastInsertedId();
				$ficha->setId_tema_estudo($id_tema_estudo);
				
				//Resumo
				$rdao=new ResumoDAO();
				$resumo=new Resumo('','');
				$resumo->setResumo(upper($_POST["resumo"]));
				$rdao->insertData($resumo);
				$id_resumo=$rdao->getLastInsertedId();
				$ficha->setId_resumo($id_resumo);
				
				//Detalhes Finais
				$dfdao=new Detalhes_finaisDAO();
				$detalhes_finais=new Detalhes_finais('','','','','','','');
				...
				$detalhes_finais->setData_classificacao($_POST["dataclassificacao"]);
				$dfdao->insertData($detalhes_finais);
				$id_detalhes_finais=$dfdao->getLastInsertedId();
				$ficha->setId_detalhes_finais($id_resumo);
				
				//Público envolvido
				$publForm=$_POST["naoescolarS"];
				if($publForm==""){
					$ficha->setId_publico_envolvido(null);
				} else if($publForm=="new"){
					$novoPublico=new Publico_envolvido("",upper($_POST["naoescolar"]));
					$pdao=new Publico_envolvidoDAO();
					$pdao->insertData($novoPublico);
					$id=$pdao->getLastInsertedId();
					$ficha->setId_publico_envolvido($id);
				} else {
					$ficha->setId_publico_envolvido($publForm);
				}
				
				//Area Conhecimento
				$acdao=new Area_conhecimentoDAO();
				$area_conhecimento=new Area_conhecimento('','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','');
				...
				$acdao->insertData($area_conhecimento);
				$id_area_conhecimento=$acdao->getLastInsertedId();
				$ficha->setId_area_conhecimento($id_area_conhecimento);
				...
				$mdao->insertData($modalidades);
				$id_modalidades=$mdao->getLastInsertedId();
				$ficha->setId_modalidades($id_modalidades);
				
				//Area Currícular
				$id_area_curricular=$ficha->getId_area_curricular();
				$acrdao=new Area_curricularDAO();
				$area_curricular=new Area_curricular('','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','','');
				...
				$acrdao->insertData($area_curricular);
				$id_area_curricular=$acrdao->getLastInsertedId();
				$ficha->setId_area_curricular($id_area_curricular);
				
				$fidao->insertData($ficha);
				echo "A ficha foi adicionada com sucesso<br /><br /><a href=\"index.php\" alt=\"Voltar\">Voltar</a>";
		?>
	</body>
</html>